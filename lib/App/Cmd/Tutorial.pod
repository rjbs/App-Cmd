...
=item *
  ...
  use phase: first load all packages 
  YourApp::usage_desc
  YourApp::global_opt_spec ($self) 
  YourApp::Comand::Initialize::opt_spec ($self, $app)
  YourApp::Comand::Initialize::validate_args ($self, $opts, $args)
  YourApp::Comand::Initialize::execute ($self, $opts,$args)
